...
const AttemptSnapshotModel = (mongoose.models.AttemptSnapshot as Model<AttemptSnapshotDocument>) || model<AttemptSnapshotDocument>("AttemptSnapshot", AttemptSnapshotSchema);
