...
export default function QuestionsPage({ params }: { params: { quizId: string } }) {
  ...
  async function loadQuestions() {
    const res = await apiFetch(`/api/quizzes/${params.quizId}/questions`);
  ...
  async function upload() {
    ...
    const res = await apiFetch(`/api/quizzes/${params.quizId}/questions/upload`, {
      method: "POST",
    ...
    setUploading(false);
    if (!res.ok) {
      setMessage(data?.error || "Upload failed. Use CSV with headers: Question,OptionA,OptionB,OptionC,OptionD,CorrectLetter.");
      return;
    }
  ...
  async function saveQuestion(questionId: string) {
    ...
    const res = await apiFetch(`/api/quizzes/${params.quizId}/questions/${questionId}`, {
      method: "PATCH",
  ...
  async function deleteQuestion(questionId: string) {
    ...
    await apiFetch(`/api/quizzes/${params.quizId}/questions/${questionId}`, { method: "DELETE" });
    await loadQuestions();
  }
  ...
  async function deleteAll() {
    ...
    setDeletingAll(true);
    await apiFetch(`/api/quizzes/${params.quizId}/questions`, { method: "DELETE" });
    await loadQuestions();
